...
def infer_business_profile(idea: str, requirements: dict) -> dict:
    ...
    profiles = [
        ...
        },
        {
            ...
            "recordLabel": "member session",
            "queueLabel": "class schedule",
            "followUpLabel": "member renewal follow-up",
            "services": ["Personal training session", "Yoga class booking", "Zumba batch", "Membership renewal"],
        },
        {
            "keywords": ["restaurant", "cafe", "food", "dining", "table", "menu", "kitchen", "takeaway", "delivery order"],
            "businessType": "restaurant",
            "recordLabel": "food order",
            "queueLabel": "kitchen queue",
            "followUpLabel": "guest follow-up",
            "services": ["Dine-in table order", "Takeaway order", "Delivery order", "Catering booking"],
        },
        {
            "keywords": ["coaching center", "coaching centre", "coaching", "tuition", "school", "student", "academy", "class batch"],
            "businessType": "coaching center",
            "recordLabel": "student enrollment",
            "queueLabel": "batch schedule",
            "followUpLabel": "parent follow-up",
            "services": ["Math batch enrollment", "Exam doubt session", "Fee reminder", "Parent meeting"],
        },
    ]
